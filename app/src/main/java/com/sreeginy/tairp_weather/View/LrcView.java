package com.sreeginy.tairp_weather.View;
...
import com.sreeginy.tairp_weather.Model.ILrcViewListener;
...
public class LrcView extends View implements ILrcView {
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        /*
          当前高亮歌词的字体颜色为白色
         */
        int mHignlightRowColor = Color.WHITE;
        if (mLrcRows == null || mLrcRows.isEmpty()) {
            /*
              当没有歌词的时候展示的内容
             */
            String mLoadingLrcTip = "下载歌词……";
        ...
        if (mDisplayMode == DISPLAY_MODE_SEEK) {
             ...
             */
            int mSeekLineTextColor = Color.CYAN;
...
//        }
    ...
    private int getScale(MotionEvent event) {
        ...
        float maxOffset; // max offset between x or y axis,used to decide scale size
